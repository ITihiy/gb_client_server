...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.ip_label = QLabel('Listen address:', self)
        self.ip_label.move(10, 148)
        self.ip_label.setFixedSize(180, 15)

        # Метка с напоминанием о пустом поле.
        self.ip_label_note = QLabel(' leave blank\n for all.', self)
    ...
    def save_server_config(self):
        ...
        try:
            ...
            message.warning(self, 'Error', 'Por must be a number')
        else:
            ...
            if 1023 < port < 65536:
                ...
                message.warning(self, 'Error', 'Port must be in range 1024 - 65536')
